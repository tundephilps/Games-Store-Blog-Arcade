...
function Drop({ options }) {
  ...
  return (
    <div>
      ...
      {showOptions && (
        <div
          class="absolute right-0 mt-[29px] w-[25rem] origin-top-right rounded-md bg-grey-500 font-primary bg-[#0e0d0d] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          role="menu"
